...
![Nordlys logo](@/assets/logo.png)
  or
![Nordlys logo](../../assets/logo.png)
  or
![Nordlys logo](src/assets/logo.png)
```
...
<Image alt="Nordlys favicon" src="/favicon.png" loading="lazy" width={128} height={128} class="mx-auto"/>
...
openGraphImage: "../../assets/logo.png"
  or
openGraphImage: "src/assets/logo.png"
```
...
openGraphImage: "/favicon.png"
  or
openGraphImage: "https://nordlys.fjelloverflow.dev/favicon.png"
```
